...
/*function random(number1 = 0, number2 = 1) {



}
console.log("\nExercise2: " + numberValid());
console.log("Exercise2: " + numberValid(1, 10));*/

/*3. Write a function that predicts your fortune with a message like this: "You will be an X in Y, and married to Z
with N children". Each value predicted is taken randomly from an array specifically dedicated to it, where several
...
function fortune() {
    ...
    let nameCouple = ["Lucila", "Paca", "Pepi", "Maria", "Lucia"];
...
/*4. Credit Card Validation follows these rules:
    ...
    ● You must have at least two different digits represented (all digits cannot be the same)
    ● The final digit must be even
    ● The sum of all the digits must be greater than 16
Create a function that takes a credit card number as argument and returns true or false after
validation. The following credit card numbers are valid:
    ● 9999777788880000
    ● 6666666666661666

...
let container = document.querySelector(".tableData");
let dataCompanies = COMPANIES;

/******************************************************************************************************/
let continents = [], index = 0;

for (let continent of dataCompanies) {
    continents[index++] = continent.continent;
}
console.log(continents);

/******************************************************************************************************/
let countries = [], nameCountries = [];

index = 0;
for (let country of dataCompanies) {
    countries[index] = country.countries;
    index++;
}
...
for (let i = 0; i < countries.length; i++) {
    for (let j = 0; j < countries[i].length; j++) {
        nameCountries[index++] = countries[i][j].name;
    }
}
...
let companies = [], nameCompanies = [];

index = 0;
for (let i = 0; i < countries.length; i++) {
    for (let j = 0; j < countries[i].length; j++) {
        companies[index++] = countries[i][j].companies;
    }
}
...
for (let i = 0; i < companies.length; i++) {
    for (let j = 0; j < companies[i].length; j++) {
        nameCompanies[index++] = companies[i][j];
    }
}
